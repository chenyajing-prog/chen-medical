...
你需要自动判断文件类型（CT报告/超声报告/血常规/血脂检查/病理报告/体检报告/处方单/用药医嘱等），然后进行针对性分析。
...
请严格以JSON格式返回，格式如下：
{
  ...
  "risk_level": "高/中/低",
  "summary": "1-2句话总结核心内容",
  "findings": ["发现1（包含具体数值、位置、大小等细节）", "发现2", "发现3"],
...
重要要求：
- findings 必须包含报告中所有具体数值、大小、位置、形态描述
- 异常指标必须注明正常参考范围
- 如有需要特别关注的异常，单独列出并说明原因
